classdef TaskDemo < handle
    ...
    methods
       ...
       function serveBeer(self)
           ...
           self.BeerRecaller(GPick2,GPlace2,self.COgrip,GP)

           self.BeerReturner(self.CO,self.UR,GPick,GPlace,self.COgrip,GP)
       ...
       function BeerRecaller(GPick,GPlace,GP)
           %to start
       ...
       function BeerReturner(GPick,GPlace,GP)
           %return cup
           current = tform2trvec(self.UR.fkine(self.UR.getpos).T);
